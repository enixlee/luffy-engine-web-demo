...
export const RpcSDKZhongBaiTransactionConsumeExportConsumeDetailMethod = '/sdk_zhongbai/transaction/consume/export_consume_detail';

export const RpcSDKZhongBaiTransactionConsumeExportConsumeDetailRpcType = 'ZBSystem';
 ...
 * @constructor
 */
export function RpcSDKZhongBaiTransactionConsumeExportConsumeDetail (
  ...
  if (debug.isProduction()) {
    return Rpc.post(RpcSDKZhongBaiTransactionConsumeExportConsumeDetailMethod, params);
  } else {
    return Rpc.get(RpcSDKZhongBaiTransactionConsumeExportConsumeDetailMethod, params);
  }
}
